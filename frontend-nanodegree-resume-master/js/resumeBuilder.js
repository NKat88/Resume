...
var bio = {
	...
	"skills": ["Ballroom Dancing", " Juggling", " Blowing Bubbles", "Listening", "Finding Mistakes", "Rollerblading", "Untying Knots", "Day Dreaming"]
};
...
var work = {
	"jobs": [
		...
		},
		{
			...
			"url": "http://www.thyroiddietcoach.com"
		},
		{
...
work.display = function() {
	for (let job of work.jobs) {
		...
		if (job.url) {
			formattedEmployer = formattedEmployer.replace("%link%", job.url);
		} else {
