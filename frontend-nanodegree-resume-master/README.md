...
* Note: In order for the paint by numbers map to display properly, it may need to be run through a server, rather than just the web browser. In order to do this, go to the terminal and change directory to the folder that contains the HTML file. Run the following command: python -m SimpleHTTPServer 8000. Then load the page in the browser by typing: localhost: 8000/index.html.
*Note: I have additional files in my directory because I am linking to certain files in my projects section.